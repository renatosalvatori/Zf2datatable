...
class PersonZendController extends AbstractActionController {
	...
	public function bootstrapAction() {
		...
		$colgender->setReplaceValues ( array (
				'm' => 'male',
				'f' => 'female' 
		) );
		...
		$grid->setFrmElementSource(
		    array(
		        'primaryGroupId'=>array('source'=>'db','table'=>'group','id'=>'id','value'=>'name','type'=>'SELECT'),
		         'gender'=>array('source'=>'array','array_value'=>array('m'=>'Male','f'=>'Female'),'type'=>'SELECT')
		...
		$grid->setConditionCrudColumn(
		    array('editCrud'=>array('field'=>$colgender,'filter'=>'male','filter_crud'=>'m','filter_perator'=> \Zf2datatable\Filter::EQUAL),
	              'deleteCrud'=>array('field'=>$colgender,'filter'=>'male','filter_crud'=>'m','filter_perator'=> \Zf2datatable\Filter::EQUAL)));
