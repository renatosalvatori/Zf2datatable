...
/**
 * @covers Zf2datatable\DataSource\AbstractDataSource
 */
class AbstractDataSourceTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     *
     * @var \Zf2datatable\DataSource\AbstractDataSource
     */
    private $dsMock;
    ...
    public function setUp()
    {
        ...
        // }
        $this->dsMock = $this->getMockForAbstractClass('Zf2datatable\DataSource\AbstractDataSource', array(
            array()
        ), '', false);
    }
    ...
    public function testColumn()
    {
        ...
        $col1 = $this->getMockForAbstractClass('Zf2datatable\Column\AbstractColumn');
    ...
    public function testFilter()
    {
        ...
        $filter = $this->getMock('Zf2datatable\Filter');
        $ds->addFilter($filter);
