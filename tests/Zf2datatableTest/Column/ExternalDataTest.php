...
use Zf2datatable\Column\DataPopulation;

/**
 * @group Column
 * @covers Zf2datatable\Column\ExternalData
 */
class ExternalDataTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testSetGetData()
    {
        ...
        $this->assertInstanceOf('Zf2datatable\Column\DataPopulation\Object', $col->getDataPopulation());
    }
