...
class DatagridTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testDataSourceArray()
    {
        ...
        $this->assertInstanceOf('Zf2datatable\DataSource\PhpArray', $grid->getDataSource());

        $source = $this->getMock('Zf2datatable\DataSource\PhpArray', array(), array(
            array()
        ));
    ...
    public function testDataSourceZend()
    {
        ...
        // $this->assertInstanceOf('Zf2datatable\DataSource\PhpArray', $this->grid->getDataSource());
    ...
    public function testDataSourceZendSelect()
    {
        ...
        $this->assertTrue($grid->hasDataSource());
        $this->assertInstanceOf('Zf2datatable\Datasource\ZendSelect', $grid->getDataSource());
    ...
    public function testDataSourceDoctrine()
    {
        ...
        $this->assertTrue($grid->hasDataSource());
        $this->assertInstanceOf('Zf2datatable\DataSource\Doctrine2', $grid->getDataSource());
    }
    ...
    public function testAddColumnArrayFQN()
    {
        ...
        $column = array(
            'colType' => 'Zf2datatable\Column\Select',
            'label' => 'My label',
            'select' => array(
                'column' => 'myCol',
                'table' => 'myTable'
        ...
        $this->assertInstanceOf('Zf2datatable\Column\Select', $col);
    ...
    public function testAddColumnArrayInvalidColType()
    {
        ...
        $column = array(
            'colType' => 'Zf2datatable\Column\Unknown',
            'label' => 'My label'
        );

        $this->setExpectedException('InvalidArgumentException', 'Column type: "Zf2datatable\Column\Unknown" not found!');
        $grid->addColumn($column);
    }
    ...
    public function testAddColumnArraySelectInvalidArgumentException()
    {
        ...
        $this->setExpectedException('InvalidArgumentException', 'For "Zf2datatable\Column\Select" the option select[column] must be defined!');
        $grid->addColumn($column);
    }
    ...
    public function testAddColumnArrayTypeAction()
    {
        ...
        $this->assertInstanceOf('Zf2datatable\Column\Action', $col);
    ...
    public function testRowStyle()
    {
        ...
        $grid->addRowStyle($this->getMock('Zf2datatable\Column\Style\Bold'));
        $this->assertCount(1, $grid->getRowStyles());
        $this->assertTrue($grid->hasRowStyles());

        $grid->addRowStyle($this->getMock('Zf2datatable\Column\Style\Italic'));
