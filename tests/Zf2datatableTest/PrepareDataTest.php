...
use Zf2datatable\PrepareData;
use Zf2datatable\Column\Type;
use Zf2datatable\Column\DataPopulation\Object;

/**
 * @covers Zf2datatable\PrepareData
 */
class PrepareDataTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testPrepareDataPopulation()
    {
        ...
        $mock = $this->getMock('Zf2datatable\Column\DataPopulation\Object\Gravatar');
        ...
        $col = $this->getMock('Zf2datatable\Column\ExternalData');
